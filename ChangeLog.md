...
- OceanFloor-1.12.2-1.0.2
- rsgauges-1.12.2-1.2.8
- ScalingHealth-1.12.2-1.3.42+147
- SilentLib-1.12.2-3.0.14+168
...
- galacticraft
4. Config：
- incontrol: spawn rules modification
- mod director: url update
- mage: visual configs changes
- default options: update the config.txt
- global game rule: modified rules
5. 新的加载动画
6. 新的音乐
7. 加入新的patchouli手册（未完成）
8. 修改ftb quests
9. 增加自定义成就（triumph）
10. 删除推荐光影包
11. 修改craft tweaker脚本
- new crafting recipe
- added an incomplete script
12. 修复bugs：
